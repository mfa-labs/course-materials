...
Mata kuliah Machine Learning ini dirancang berdasarkan Outcome-Based Education (OBE) yang menekankan pencapaian kompetensi mahasiswa melalui hasil pembelajaran yang terukur. Kursus ini mencakup konsep dasar hingga aplikasi praktis machine learning, dengan fokus pada pengembangan keterampilan analitis dan implementasi model.

## Tujuan Kursus (Course Objectives)
1. Memberikan pemahaman mendalam tentang prinsip-prinsip machine learning
2. Mengembangkan kemampuan mahasiswa dalam mengimplementasikan algoritma ML
3. Melatih mahasiswa dalam evaluasi dan optimasi model ML
4. Mendorong pemikiran kritis tentang etika dan dampak ML di masyarakat
...
## Metode Pembelajaran
- Kuliah interaktif
- Tutorial praktis dengan Python
- Diskusi kelas
- Proyek akhir
- Peer assessment
